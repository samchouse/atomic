...
const Index: React.FC = () => {
  return (
    <div className="flex flex-col h-screen justify-center text-center">
      ...
      <h3 className="text-white dark:text-white pt-5 text-lg">
      ...
      <p className="text-gray-500 dark:text-gray-400 pt-1 italic text-base">
        If you want it out quick how about you come and help me? :D
      </p>
    </div>
  );
};
